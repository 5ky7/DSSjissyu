...
from src.models.dcc import fit_dcc, simulate_dcc
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--params-output", default="reports/tables/dcc_params.csv")
    parser.add_argument("--corr-output", default="data/processed/dcc_correlations.csv")
    parser.add_argument("--generated-output", default="data/generated/dcc/generated_paths.csv")
